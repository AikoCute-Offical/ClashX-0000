...
ClashX Aims to provide a simple and lightweight proxy client, if you need more customization, you can consider using [CFW Mac Version](https://github.com/Fndroid/clash_for_windows_pkg/releases) 
...
You can download from [Release](https://github.com/AikoCute-Offical/ClashX/releases) page
...
### Turn off notifications from ClashX

1. Turn off the push permission of clashx in the system settings
2. Execute
```
...
Note: This is strongly not recommended, it may cause many important error reminders of crashx to not be displayed.
### Global shortcut keys

- Click for setting details [Global shortcut keys](Shortcuts.md)