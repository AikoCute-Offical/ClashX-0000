...
class NetworkChangeNotifier {
    ...
    private static func startProxiesWatch() {
        ...
        if let dynamicStore = SCDynamicStoreCreate(kCFAllocatorDefault, "com.AikoX.proxy.networknotification" as CFString, changed, dcAddress) {
    ...
    private static func startIPChangeWatch() {
        ...
        if let dynamicStore = SCDynamicStoreCreate(kCFAllocatorDefault, "com.AikoX.ipv4.networknotification" as CFString, changed, dcAddress) {
    ...
    static func hasInterfaceProxySetToClash() -> Bool {
        ...
        if let prefRef = SCPreferencesCreate(nil, "AikoX" as CFString, nil),
    ...
    static func getPrimaryInterface() -> String? {
        let store = SCDynamicStoreCreate(nil, "AikoX" as CFString, nil, nil)
        if store == nil {
            return nil
        }
